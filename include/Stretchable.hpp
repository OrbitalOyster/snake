...
private:
  ...
  void render_bottom(SDL_FRect rect) const;
  void render_left(SDL_FRect rect) const;
  void render_top_left(SDL_FRect rect) const;
  void render_top_right(SDL_FRect rect) const;
  void render_bottom_right(SDL_FRect rect) const;
  void render_bottom_left(SDL_FRect rect) const;
...
public:
  Stretchable(Texture *texture, SDL_FRect center, SDL_FRect top_left,
              ...
              SDL_FRect left);
  void render(SDL_FRect rect) const;
};
